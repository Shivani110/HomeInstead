...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="../assets/css/style.css?kjhh">
    <link rel="stylesheet" href="../assets/css/responsive.css?jhh">
...
<body>
                ...
                <div id="my-consulation-form" class="consulation consulation-form-section-form ">
                    ...
                    <div class="consulation-content">
                        ...
                        <form id="myForm" method="post">
                            ...
                            <div class="form-group">
                                <div class="g-recaptcha" id="example"></div>
                            </div> 
                    ...
                    <div class="consulation-form-section-content">
                        <div class="consulation-form-section-form ">
                            ...
                            <form id="myForm2" method="post">
                                ...
                                <div class="form-group">
                                    <div class="g-recaptcha" id="example2" data-sitekey="6LfH_YspAAAAAB8NZEBR5EkdB9aRtNHBDZdsDmFt"></div>
                                </div>
                                <!-- <textarea class="form-control" placeholder="How can we help you?" rows="5"></textarea> -->
            ...
            <div class="bottom-form-sec-content">
                ...
                <div class="bottom-form-sec-form ">
                    ...
                    <form class="bottom-form" id="myForm3" method="POST">
                        ...
                        <div class="form-group">
                            <div class="g-recaptcha"  id="example1" data-sitekey="6LfH_YspAAAAAB8NZEBR5EkdB9aRtNHBDZdsDmFt"></div>
                        </div>
    ...
    <script src="../assets/js/index.js?tfdy"></script>
    ...
    <script>
        ...
        var onloadCallback = function() {
            widgetId = grecaptcha.render(document.getElementById('example'), {
                'sitekey' : '6LfH_YspAAAAAB8NZEBR5EkdB9aRtNHBDZdsDmFt',
            });
